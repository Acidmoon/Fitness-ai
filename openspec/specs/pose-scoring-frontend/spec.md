# Pose Scoring Frontend Specification

## Purpose

Define frontend behavior for previewing and explicitly applying pose-derived scoring results from the record detail page.
